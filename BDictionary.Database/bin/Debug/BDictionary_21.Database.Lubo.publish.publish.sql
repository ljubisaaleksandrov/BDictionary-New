...
GO
/*
The column [dbo].[QuestionCategory].[DateCreated] on table [dbo].[QuestionCategory] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Altering [dbo].[QuestionCategory]...';
...
GO
PRINT N'Creating [dbo].[QuestionCreator]...';
...
GO
PRINT N'Creating [dbo].[FK_QuestionCreator_Question]...';


GO
ALTER TABLE [dbo].[QuestionCreator] WITH NOCHECK
    ADD CONSTRAINT [FK_QuestionCreator_Question] FOREIGN KEY ([QuestionID]) REFERENCES [dbo].[Question] ([Id]) ON DELETE CASCADE;


GO
PRINT N'Creating [dbo].[FK_QuestionCreator_User]...';


GO
ALTER TABLE [dbo].[QuestionCreator] WITH NOCHECK
    ADD CONSTRAINT [FK_QuestionCreator_User] FOREIGN KEY ([UserID]) REFERENCES [dbo].[AspNetUsers] ([Id]);
...
GO
ALTER TABLE [dbo].[QuestionCreator] WITH CHECK CHECK CONSTRAINT [FK_QuestionCreator_Question];

ALTER TABLE [dbo].[QuestionCreator] WITH CHECK CHECK CONSTRAINT [FK_QuestionCreator_User];
