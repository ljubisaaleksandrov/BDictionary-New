...
GO
/*
The column [dbo].[Question].[IsShis] is being dropped, data loss could occur.

The column [dbo].[Question].[IsShiz] on table [dbo].[Question] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Question] ([Id], [Value], [AnswerID], [Creator], [CategoryID])
        SELECT   [Id],
                 [Value],
                 [AnswerID],
                 [Creator],
