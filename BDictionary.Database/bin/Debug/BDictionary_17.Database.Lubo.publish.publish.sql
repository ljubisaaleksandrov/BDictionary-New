...
IF EXISTS (select top 1 1 from [dbo].[Word])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping [dbo].[FK_Word_FirstSynonym]...';


GO
ALTER TABLE [dbo].[Synonym] DROP CONSTRAINT [FK_Word_FirstSynonym];


GO
PRINT N'Dropping [dbo].[FK_Word_SecondSynonym]...';


GO
ALTER TABLE [dbo].[Synonym] DROP CONSTRAINT [FK_Word_SecondSynonym];


GO
PRINT N'Dropping [dbo].[FK_Word_WordType]...';


GO
ALTER TABLE [dbo].[Word] DROP CONSTRAINT [FK_Word_WordType];


GO
PRINT N'Starting rebuilding table [dbo].[Word]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Word] (
    [Id]          INT            IDENTITY (1, 1) NOT NULL,
    [Value]       NVARCHAR (30)  NOT NULL,
    [Description] NVARCHAR (MAX) NOT NULL,
    [Example]     NVARCHAR (MAX) NOT NULL,
    [TypeID]      INT            NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_dbo.Word1] PRIMARY KEY CLUSTERED ([Id] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Word])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Word] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Word] ([Id], [Value], [Description], [TypeID])
        SELECT   [Id],
                 [Value],
                 [Description],
                 [TypeID]
        FROM     [dbo].[Word]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Word] OFF;
    END

DROP TABLE [dbo].[Word];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Word]', N'Word';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_dbo.Word1]', N'PK_dbo.Word', N'OBJECT';
